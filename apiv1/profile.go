...
type ProfileIndexReq struct {
	g.Meta `path:"/profile" method:"get" summary:"展示个人资料页面" tags:"用户"`
}
...
type ProfileUpdateReq struct {
	g.Meta   `path:"/profile" method:"post" summary:"修改个人资料" tags:"用户"`
...
type ProfileAvatarReq struct {
	g.Meta `path:"/profile/avatar" method:"get" summary:"展示头像管理页面" tags:"用户"`
}
...
type ProfileUpdateAvatarReq struct {
	g.Meta `path:"/profile/avatar" method:"post" summary:"修改个人头像" tags:"用户"`
	Id     uint   `json:"id"     dc:"用户ID"`
	Avatar string `json:"avatar" dc:"头像地址"`
}
...
type ProfilePasswordReq struct {
	g.Meta `path:"/profile/password" method:"get" summary:"展示密码修改页面" tags:"用户"`
}
...
type ProfileUpdatePasswordReq struct {
	g.Meta      `path:"/profile/password" method:"post" summary:"修改个人密码" tags:"用户"`
...
type ProfileMessageReq struct {
	g.Meta `path:"/profile/message" method:"get" summary:"展示查询用户消息列表页面" tags:"用户"`
	CommonPaginationReq
...
type ProfileLogoutReq struct {
	g.Meta `path:"/profile/logout" method:"delete" summary:"执行用户注销接口" tags:"用户"`
}
